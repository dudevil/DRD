...
\subsection{Microaneurysm detection}
...
\only<2>{
	\includegraphics[width=0.7\textwidth]{pics/classified_samples/82_right_2.jpg}
}

\only<3>{
	\includegraphics[width=0.7\textwidth]{pics/classified_samples/82_right_2_blobs.jpg}
}
