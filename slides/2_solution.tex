...
\begin{tikzpicture}
	    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[valign=c,height=1.5cm]{pics/10_left.png}};
		\begin{scope}[x={(image.south east)},y={(image.north west)}]
			\draw[red,thick] (0,0) rectangle (0.5,0.5);
			\draw[green,thick] (0.5,0.5) rectangle (1,1);
			\draw[yellow,thick] (0,0.5) rectangle (0.5,1);
